...
// VeterinariaController operations for Veterinaria
type VeterinariaController struct {
	beego.Controller
}

// URLMapping ...
func (c *VeterinariaController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Veterinaria
// @Param	body		body 	models.Veterinaria	true		"body for Veterinaria content"
// @Success 201 {int} models.Veterinaria
// @Failure 403 body is empty
// @router / [post]
func (c *VeterinariaController) Post() {
	var v models.Veterinaria
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddVeterinaria(&v); err == nil {
...
// GetOne ...
// @Title Get One
// @Description get Veterinaria by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Veterinaria
// @Failure 403 :id is empty
// @router /:id [get]
func (c *VeterinariaController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *VeterinariaController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// Put ...
// @Title Put
// @Description update the Veterinaria
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Veterinaria	true		"body for Veterinaria content"
// @Success 200 {object} models.Veterinaria
// @Failure 403 :id is not int
// @router /:id [put]
func (c *VeterinariaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Veterinaria{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateVeterinariaById(&v); err == nil {
...
// Delete ...
// @Title Delete
// @Description delete the Veterinaria
