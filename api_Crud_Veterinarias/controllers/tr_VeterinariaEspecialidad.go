...
// URLMapping ...
func (c *TrVeterinariaEspecialidadController) URLMapping() {
...
func (c *TrVeterinariaEspecialidadController) Post() {
	var v models.TrVeterinariaEspecialidad
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTrVeterinariaEspecialidad(&v); err == nil {
...
func (c *TrVeterinariaEspecialidadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TrVeterinariaEspecialidad{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTrVeterinariaEspecialidadById(&v); err == nil {
