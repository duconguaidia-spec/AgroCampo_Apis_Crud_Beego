...
// ReporteactividadController operations for Reporteactividad
type ReporteactividadController struct {
	beego.Controller
}

// URLMapping ...
func (c *ReporteactividadController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Reporteactividad
// @Param	body		body 	models.Reporteactividad	true		"body for Reporteactividad content"
// @Success 201 {int} models.Reporteactividad
// @Failure 403 body is empty
// @router / [post]
func (c *ReporteactividadController) Post() {
	var v models.Reporteactividad
...
// @Success 200 {object} models.Reporteactividad
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ReporteactividadController) GetOne() {
...
// GetAll ...
// @Title Get All
// @Description get Reporteactividad
...
// @Failure 403
// @router / [get]
func (c *ReporteactividadController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// Put ...
// @Title Put
// @Description update the Reporteactividad
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Reporteactividad	true		"body for Reporteactividad content"
// @Success 200 {object} models.Reporteactividad
// @Failure 403 :id is not int
// @router /:id [put]
func (c *ReporteactividadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Reporteactividad{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateReporteactividadById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// Delete ...
// @Title Delete
// @Description delete the Reporteactividad
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ReporteactividadController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteReporteactividad(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
