...
type PreguntafrecuenteController struct {
	beego.Controller
}

// URLMapping ...
func (c *PreguntafrecuenteController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Preguntafrecuente
// @Param	body		body 	models.Preguntafrecuente	true		"body for Preguntafrecuente content"
// @Success 201 {int} models.Preguntafrecuente
// @Failure 403 body is empty
// @router / [post]
func (c *PreguntafrecuenteController) Post() {
	var v models.Preguntafrecuente
...
// GetOne ...
// @Title Get One
// @Description get Preguntafrecuente by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Preguntafrecuente
// @Failure 403 :id is empty
// @router /:id [get]
func (c *PreguntafrecuenteController) GetOne() {
...
// GetAll ...
// @Title Get All
// @Description get Preguntafrecuente
...
// @Failure 403
// @router / [get]
func (c *PreguntafrecuenteController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
c.ServeJSON()
	...
	l, err := models.GetAllPreguntafrecuente(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Preguntafrecuente
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Preguntafrecuente	true		"body for Preguntafrecuente content"
// @Success 200 {object} models.Preguntafrecuente
// @Failure 403 :id is not int
// @router /:id [put]
func (c *PreguntafrecuenteController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Preguntafrecuente{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePreguntafrecuenteById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
