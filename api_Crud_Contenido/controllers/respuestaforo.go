...
type RespuestaforoController struct {
	beego.Controller
}

// URLMapping ...
func (c *RespuestaforoController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Respuestaforo
// @Param	body		body 	models.Respuestaforo	true		"body for Respuestaforo content"
// @Success 201 {int} models.Respuestaforo
...
// @Success 200 {object} models.Respuestaforo
// @Failure 403 :id is empty
// @router /:id [get]
func (c *RespuestaforoController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *RespuestaforoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllRespuestaforo(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Respuestaforo
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Respuestaforo	true		"body for Respuestaforo content"
// @Success 200 {object} models.Respuestaforo
// @Failure 403 :id is not int
// @router /:id [put]
func (c *RespuestaforoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Respuestaforo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateRespuestaforoById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *RespuestaforoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteRespuestaforo(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
