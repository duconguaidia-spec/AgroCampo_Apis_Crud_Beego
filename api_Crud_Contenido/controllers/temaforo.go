...
// TemaforoController operations for Temaforo
type TemaforoController struct {
	beego.Controller
}

// URLMapping ...
func (c *TemaforoController) URLMapping() {
...
// Post ...
// @Title Post
// @Description create Temaforo
// @Param	body		body 	models.Temaforo	true		"body for Temaforo content"
// @Success 201 {int} models.Temaforo
...
// GetOne ...
// @Title Get One
// @Description get Temaforo by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.Temaforo
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TemaforoController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *TemaforoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTemaforo(query, fields, sortby, order, offset, limit)
	if err != nil {
...
// Put ...
// @Title Put
// @Description update the Temaforo
// @Param	id		path 	string	true		"The id you want to update"
// @Param	body		body 	models.Temaforo	true		"body for Temaforo content"
// @Success 200 {object} models.Temaforo
// @Failure 403 :id is not int
// @router /:id [put]
func (c *TemaforoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Temaforo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTemaforoById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// Delete ...
// @Title Delete
// @Description delete the Temaforo
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /:id [delete]
func (c *TemaforoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTemaforo(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
